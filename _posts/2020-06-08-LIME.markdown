...
# ตัวอย่างขั้นตอนของ LIME สำหรับ Image Classification
...
ซึ่งเค้าทำตัวอย่างการใช้งานกับทั้ง tabular data, text, image ซึ่งสามารถตาม <a href='https://github.com/marcotcr/lime/tree/ce2db6f20f47c3330beb107bb17fd25840ca4606/doc/notebooks'>link นี้</a> ไปได้เลย ซึ่งเค้าทำออกมาดูดีมากเลย
