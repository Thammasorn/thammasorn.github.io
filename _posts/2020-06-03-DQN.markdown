...
img_thumbnail: /assets/img/thumbnail/DQN.jpg
...
![alt text](/assets/img/DQN/pseudo-code.png)
...
การทำแบบนี้มีข้อดี 3 ประการด้วยกัน
...
![alt text](/assets/img/DQN/pseudo-code-2.png)


## Implementation

ในส่วนนี้จะพาทุกท่านมาเขียนโค้ด DQN อย่างง่ายกัน โดยเราจะใช้แค่ numpy และ keras เท่านั้น
...
5. โค้ดในการเทรน DQN ทั้งหมดจะเป็นแบบนี้
	...
	- แล้วเราก็หาค่า target ของ Q(s,a) ของแต่ละ experience 
		...
		จะเห็นได้ว่า เราใช้วิธีคูณด้วย ```(1-batch[:,4])``` แทนที่จะแยกเคสเหมือนใน pseodo code

		>ปล. batch[:,4] คือ list ของค่า done ซึ่งเป็น boolean ที่บอกว่า episode จบลงหลัง experience นั้นหรือไม่ (True คือจบ, False คือยังไม่จบ)

		โดยที่ขั้นตอนโดยละเอียดมีดังนี้ 
		...
		- ต่อมาเอาค่า max ของ Q(s',a) มารวมกับ reward เพื่อสร้างเป็นค่า target value ตามสูตร Bellman Equation
			> รูปด้านล่างสมมติให้ reward discount factor เป็น 0.9
...
- <a href='https://storage.googleapis.com/deepmind-media/dqn/DQNNaturePaper.pdf'>level control through deep reinforcement learning</a>
