...
โดยที่วิธี minimize เทอม $$\mathcal{L}(f,g,\pi_x)$$ นี้ ก็คือการที่เราจะ train ต้ว explainer model ให้ทำนายผลการทำนายของโมเดลหลักเรา หรือก็คือ $f(z)$ ด้วยข้อมูล $z$ โดยตอนเทรนนั้น เราจะตั้ง sample weight ของ $z$ แต่ละตัวด้วยค่า $\pi_x(z)$ นั่นเอง 
