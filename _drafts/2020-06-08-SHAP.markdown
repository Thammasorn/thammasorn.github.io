---
layout: post
title:  "ทำไมถึง predict แบบนี้นะ? (SHAP value)"
date:   2020-06-03 18:00:00 +0700
img_thumbnail: /assets/img/thumbnail/shap
img_header: /assets/img/header/shap
description: "บทความนี้จะพูดถึงการหาว่าแต่ละฟีเจอร์ใดส่งผลต่อผลการทำนายอย่างไรบ้างด้วยการใช้ SHAP โดยที่"
